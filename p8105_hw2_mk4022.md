...
The pol dataset shows who was in power from 1947 to 2015. The dataset
snp shows S\&P 500 data from 1950 to 2015. The dataset unemploy shows
...
`sen_gop`,`prez`, and `snp`. The database final has 822 observations
between 1947 to 2015.
